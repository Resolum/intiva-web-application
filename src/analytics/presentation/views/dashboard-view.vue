...
/**
 * Builds the query parameters for the dashboard API based on the selected period.
 * @returns {Object} Dashboard query parameters.
 */
...
/**
 * Computes the active range label for chart display.
 * @returns {string} Range label ('1M', '3M', '6M', or '1Y').
 */
...
/**
 * Handles user logout: resets dashboard state, clears auth, and redirects to sign-in.
 */
function onLogout() {
  dashboard.reset()
  authStore.signOut()
